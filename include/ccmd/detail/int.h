...
inline int ccmd::c_command::int_var(const char *name) {
    const std::string var_name = name;
    return int_var(var_name);
}

inline int ccmd::c_command::int_var(std::string &name) {
    return int_var(static_cast<const std::string &>(name));
}

inline int ccmd::c_command::int_var(const std::string &name) {
    return static_cast<const c_command &>(*this).int_var(name);
}

inline int ccmd::c_command::int_var(const std::string &name) const {
...
inline void ccmd::c_command::int_var(const char *name, int default_value, const char *usage) {
    std::string var_name = name;
    std::string var_usage = usage;
    int_var(var_name, default_value, var_usage);
}

inline void ccmd::c_command::int_varp(const char *name, const char *short_name, int default_value, const char *usage) {
    std::string var_name = name;
...
inline void ccmd::c_command::int_var(std::string &name, int default_value, std::string &usage) {
    int_var(static_cast<const std::string &>(name), default_value, static_cast<const std::string &>(usage));
}

inline void ccmd::c_command::int_var(const std::string &name, int default_value, const std::string &usage) {
...
inline void ccmd::c_command::int_varp(
        std::string &name, std::string &short_name, int default_value, std::string &usage) {
...
inline void ccmd::c_command::int_varp(const std::string &name, const std::string &short_name, int default_value,
